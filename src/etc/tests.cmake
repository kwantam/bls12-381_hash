...
add_test(NAME t_strm_segmenter   COMMAND fsm_stream_segmenter)
add_test(NAME t_strm_reassembler COMMAND fsm_stream_reassembler)
...
add_test(NAME t_ack_rst          COMMAND fsm_ack_rst)
add_test(NAME t_ack_rst_win      COMMAND fsm_ack_rst_win)
add_test(NAME t_connect          COMMAND fsm_connect)
add_test(NAME t_listen           COMMAND fsm_listen)
add_test(NAME t_winsize          COMMAND fsm_winsize)
add_test(NAME t_retx             COMMAND fsm_retx)
...
add_test(NAME t_eventloop_dt     COMMAND "${PROJECT_SOURCE_DIR}/doctests/eventloop_dt.sh")
add_test(NAME t_ipv4_header_dt   COMMAND ipv4_header_dt)
add_test(NAME t_parser_dt        COMMAND parser_dt)
add_test(NAME t_socket_dt        COMMAND socket_dt)
add_test(NAME t_tcp_segment_dt   COMMAND tcp_segment_dt)
add_test(NAME t_ipv4_datagram_dt COMMAND ipv4_datagram_dt)
